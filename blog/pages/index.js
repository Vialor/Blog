  ...
  return (
    ...
    <Head>
      ...
      <div id="about-me">
        <h2>About Me</h2>
        <div className="intro">
          <img src="../public/img/utsc_hw.jpg" alt="utsc_hw" className="utsc-hw"/>
          <div className="self-intro">
            ...
            <a href="../public/img/Resume.pdf" className="link">My Resume</a>
          </div>
        </div>
      </div>
      <div id="about-blog">
      ...
      <div id="contact">
        ...
        <address>
          ...
          <a href="../public/img/Wechat.jpeg" className="link">WeChat: Vial2000</a><br/>
        </address>
      </div>
    </Layout>);
}
